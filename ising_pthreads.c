...
#define L 256  // Tamaño de la cuadrícula LxL
...
int main(int argc, char* argv[]) {
    //Se definen las variables para la temperatura y de tiempo inicial/final
    float temp;
    float t1, t2;
    ...
    printf("mag_f: %f\n", calculate_magnetization(spins));
    printf("calc_time: %.3f [s], Temp: %.1f\n\n", ((double)(t2 - t1)) / (CLOCKS_PER_SEC * N_THR), temp);
